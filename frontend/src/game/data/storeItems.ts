...
export const STORE_ITEMS: StoreItem[] = [
  ...
  },
  {
    ...
    category: 'tanks',
    description: 'Classic large display footprint with strong stability and room for larger colonies.',
    price: 320,
    icon: '🐠',
    meta: { gallons: 55, maxShrimp: 550 },
  },
  {
    id: 'tank_60breeder',
    name: '60-Gallon Breeder',
    category: 'tanks',
    description: 'Wide, shallow breeder layout with excellent viewing area and expanded floor space for foraging.',
    price: 360,
    icon: '🪸',
    meta: { gallons: 60, maxShrimp: 600 },
  },
  {
    id: 'tank_75gal',
    name: '75-Gallon Show Tank',
    category: 'tanks',
    description: 'A serious display tank with high stability and major expansion room for shrimp lines.',
    price: 480,
    icon: '🌊',
    meta: { gallons: 75, maxShrimp: 750 },
  },
  {
    id: 'tank_125gal',
    name: '125-Gallon Large Display',
    category: 'tanks',
    description: 'Commercial-scale display capacity with exceptional dilution and habitat flexibility.',
    price: 780,
    icon: '🐋',
    meta: { gallons: 125, maxShrimp: 1250 },
  },
  {
    id: 'tank_200gal',
    name: '200-Gallon Monster Tank',
    category: 'tanks',
    description: 'Massive flagship aquarium for advanced colony growth, line breeding, and showcase aquascapes.',
    price: 1200,
    icon: '🦈',
    meta: { gallons: 200, maxShrimp: 2000 },
  },
